...
males = []
females = []
first_non_par_pos = None  # Define first_non_par_pos here
                    ...
                    with gzip.open(vcf_file_name, 'rt') as f:
                        for line in f:
                            try:
                                ...
                                print("Error in second part:", repr(line), file=sys.stderr)
                                print(e, file=sys.stderr)
                                raise
                    break
        except Exception as e:
            print("Error in first part:", repr(line), file=sys.stderr)
            print(e, file=sys.stderr)
            raise
